...
# echo "Sign ========================================================================"
# electron-osx-sign profit-darwin-x64/profit.app --platform=darwin \
...
# notarize-cli --file=$DMG_NAME.dmg --bundle-id net.profit.blockchain --username "williejonagvio38@gmail.com" --password "mrdo-yfcr-intb-eyxr"
