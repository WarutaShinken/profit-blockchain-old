...
# the output will be printed to your profit root path, e.g. ~/.profit/mainnet/profile/
# to analyze the profile, run:

#   python chia/utils/profiler.py ~/.chia/mainnet/profile | less -r

# this will print CPU usage of the profit full node main thread at 1 second increments.
