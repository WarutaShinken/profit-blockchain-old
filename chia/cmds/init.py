...
def init_cmd(ctx: click.Context, create_certs: str, fix_ssl_permissions: bool, testnet: bool, **kwargs):
    ...
    - Make a copy of your Farming Machine CA directory: ~/.profit/[version]/config/ssl/ca
    - Shut down all profit daemon processes with `profit stop all -d`
    - Run `profit init -c [directory]` on your remote harvester,
      where [directory] is the the copy of your Farming Machine CA directory
    - Get more details on remote harvester on Profit wiki:
      https://github.com/WarutaShinken/profit-blockchain/wiki/Farming-on-many-machines
    """
