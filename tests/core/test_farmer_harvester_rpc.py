...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "profit"), encode_puzzle_hash(new_ph_2, "profit"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "profit"))
            ...
            assert config["farmer"]["profit_target_address"] == encode_puzzle_hash(new_ph, "profit")
            assert config["pool"]["profit_target_address"] == encode_puzzle_hash(new_ph_3, "profit")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "profit")
